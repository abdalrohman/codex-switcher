...
use commands::{
    ...
    evaluate_auto_rotate, export_accounts_full_encrypted_file, export_accounts_slim_text,
    get_active_account_info, get_experimental_auto_rotate_enabled, get_masked_account_ids,
    get_opencode_sync_enabled, get_usage, import_accounts_full_encrypted_file,
    import_accounts_slim_text, list_accounts, refresh_all_accounts_usage, rename_account,
    set_experimental_auto_rotate_enabled, set_masked_account_ids, set_opencode_sync_enabled,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_experimental_auto_rotate_enabled,
            set_experimental_auto_rotate_enabled,
            evaluate_auto_rotate,
        ])
